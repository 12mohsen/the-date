...
const TRANSLATIONS = {
  ar: {
    ...
    // ── تعديل مدة محفوظة ──
    editModalTitle:     "✏️ تعديل المدة",
    editNoteLabel:      "الاسم / الملاحظة",
    editDateLabel:      "التاريخ الهدف",
    editImportanceLabel:"الأهمية",
    editModeLabel:      "نوع الحساب",
    editBaseDateLabel:  "تاريخ البداية (اختياري — يُستخدم في «من أصل»)",
    editSaveBtn:        "حفظ التعديلات",
    editNeedNote:       "يرجى كتابة اسم أو ملاحظة للمدة.",

    // ── التكرار السنوي (عيد ميلاد / ذكرى) ──
    yearlyShort:        "🎂 سنوي",
    yearlyLabel:        "🎂 يتكرر كل سنة (عيد ميلاد / ذكرى سنوية)",
    yearlyHint:         "يُحسب الموعد القادم تلقائياً كل سنة من التاريخ أعلاه، مع عرض العمر.",
    yearlyBadge:        "🎂 سنوي",
    birthdayToday:      "🎂 اليوم هو الموعد!",
    turnsAgeToday:      (n) => `يكمل اليوم ${n} سنة`,
    turnsAgeSoon:       (n) => `سيكمل ${n} سنة`,
    currentAge:         (n) => `العمر الآن ${n} سنة`,
    joinNextOccurrence: (target, today) => `الموعد القادم: ${target} (اليوم ${today}).`,
    originalDateLabel:  "التاريخ الأصلي:",
    notifBodyYearly:    "🎂 اليوم موعد: {name}",
    editNeedDate:       "يرجى اختيار تاريخ صحيح.",
  ...
  en: {
    ...
    // ── Edit saved entry ──
    editModalTitle:     "✏️ Edit entry",
    editNoteLabel:      "Name / note",
    editDateLabel:      "Target date",
    editImportanceLabel:"Importance",
    editModeLabel:      "Calculation type",
    editBaseDateLabel:  "Start date (optional — used for “out of”)",
    editSaveBtn:        "Save changes",
    editNeedNote:       "Please enter a name or note for this entry.",

    // ── Yearly repeat (birthday / anniversary) ──
    yearlyShort:        "🎂 Yearly",
    yearlyLabel:        "🎂 Repeats every year (birthday / anniversary)",
    yearlyHint:         "The next occurrence is calculated automatically each year from the date above, with the age shown.",
    yearlyBadge:        "🎂 Yearly",
    birthdayToday:      "🎂 It's today!",
    turnsAgeToday:      (n) => `Turns ${n} today`,
    turnsAgeSoon:       (n) => `Turning ${n}`,
    currentAge:         (n) => `Currently ${n} years old`,
    joinNextOccurrence: (target, today) => `Next occurrence: ${target} (today is ${today}).`,
    originalDateLabel:  "Original date:",
    notifBodyYearly:    "🎂 Today is: {name}",
    editNeedDate:       "Please pick a valid date.",
