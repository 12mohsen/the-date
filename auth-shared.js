...
//  ★ إنشاء الحساب: يمنع تكرار user_id ويحفظ مصدر التطبيق
//  ★ البيانات: كل تطبيق يفلتر جدوله الخاص بـ user_name/user_id
// ============================================================

// ──────────────────────────────────────────────
//  1) الاتصال بـ Supabase (مشترك لكل التطبيقات)
// ──────────────────────────────────────────────
...
// ──────────────────────────────────────────────
//  2) معرّف التطبيق — غيّر هذا السطر فقط لكل تطبيق
// ──────────────────────────────────────────────
//  ★★★ غيّر القيمة حسب التطبيق: ★★★
//    عداد الأيام → "days_counter"
//    النفقات     → "expenses"
//    العطور      → "perfumes"
...
//     - يمنع تكرار user_id عالمياً
//     - يحفظ created_from = APP_ORIGIN
// ──────────────────────────────────────────────
...
//     المستخدم يدخل أي تطبيق بنفس الحساب
// ──────────────────────────────────────────────
